...
class mahasiswaController extends Controller
{
    ...
    public function insertRawSQL(){
        ...
        VALUES('201002','Jonatan Hutahaean','laki-laki','Bekasi','Medan','2002-01-06','ada foto')");
    ...
    public function updateRawSQL(){
        $sql = DB::update("UPDATE mahasiswas SET nama='Johut' WHERE nama=?", ["Jonatan Hutahaean"]);
        return view('notification.updateMahasiswa');
    }
        
    public function updateQueryBuilder(){
        $sql = DB::table('mahasiswas')
        -> where('nama', 'Veronica Valentina')
        -> update([
            'photo' => 'ada foto'
        ]); 
        return view('notification.updateMahasiswa');
    ...
    public function deleteRawSQL(){
        $sql = DB::delete("DELETE FROM mahasiswas WHERE nama=?", ["Jenifer Octavia"]);
